...
> E) Gemini Flash (1.5 / 2.0 Flash — older)
> F) Gemini Pro (1.5 Pro — older)
> G) GPT-3.5 Turbo
> H) GPT-4 / GPT-4 Turbo
> I) GPT-4o
...
| Gemini Flash 1.5 / 2.0 (older) | Nova Lite ($0.06/$0.24) or Nova Micro ($0.035/$0.14)                  | Strong savings; older Flash models are being superseded by 2.5 Flash                                                                                            |
| Gemini Pro 1.5 (older)          | Claude Sonnet 4.6 ($3/$15) — quality match                            | Comparable pricing tier; 1.5 Pro is being superseded by 2.5 Pro                                                                                                 |
