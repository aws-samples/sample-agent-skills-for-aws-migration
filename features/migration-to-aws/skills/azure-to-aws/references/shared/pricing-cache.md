...
Prices per 1M tokens. For current Azure OpenAI pricing, refer to the [Azure OpenAI pricing page](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/).
...
| text-embedding-3-large | 0.13  | —           | 8K      | embedding |
| text-embedding-3-small | 0.02  | —           | 8K      | embedding |
