...
| Monthly spend        | `billing-profile.json` or `estimation-infra.json` | `summary.total_monthly_spend` or `current_costs.azure_monthly`                          |
...
- Complex Azure databases present: Synapse Analytics, Cosmos DB, or multiple SQL Servers
...
- Has databases (azurerm_mssql_server, azurerm_postgresql_flexible_server, azurerm_mysql_flexible_server)
...
- **Stage 6: Validation and Cleanup (Weeks 14-16)** — extended monitoring before Azure teardown
...
| Criteria                    | Small                      | Medium                     | Large                      |
| --------------------------- | -------------------------- | -------------------------- | -------------------------- |
| Performance within baseline | Within 10% of Azure        | Within 10% of Azure        | Within 10% of Azure        |
