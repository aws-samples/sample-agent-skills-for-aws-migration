...
![End-State Reference Architecture](diagrams/01-reference-architecture.png)
...
![Migration Architecture — Parallel-Run](diagrams/02-migration-architecture.png)
...
![Data Migration Pipeline](diagrams/03-data-migration-pipeline.png)

### End-to-End Migration Workflow

![Migration Workflow](diagrams/05-migration-workflow.png)
